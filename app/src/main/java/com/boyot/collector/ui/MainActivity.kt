...
import com.boyot.collector.classes.others.CONSTANTS.password
import com.boyot.collector.classes.others.CONSTANTS.userName
import com.boyot.collector.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val callBack: FawryConnect.OnConnectionCallBack = FawryConnect.OnConnectionCallBack(
        onConnected = { Log.d("TAG", "Boyot onConnected: ")},
